        ...
        <div class="right">
            ...
            <div class="bottom">
                ...
                <div class="catlist" id="add">
                    <p class="cattitle">
                        <i class="fas fa-pen-nib"> </i> Thêm Nhóm Khách Hàng
                    </p>
                    <div class="tabcat">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input type="text" placeholder="Tên Nhóm Khách Hàng"></td>
                            </tr>
                            <tr>
                                <td>Mô tả Nhóm</td>
                                <td><textarea name="" id="" style="width:100%" placeholder="Mô tả "></textarea></td>
                            </tr>
                            <tr>
