...
<head>
    ...
    <title>Admin::Orders::Update</title>
</head>
        ...
        <div class="menubar">
            ...
            <div class="options">
                <div class="top">
                    ...
                    <div class="searchbox">
                        <form action="#">
                            <input value="" type="search" placeholder="Tìm Kiếm">
                        </form>
                    </div>
                </div>
        ...
        <div class="right">
            ...
            <div class="bottom">
                ...
                <div class="catlist" id="add">
                    <p class="cattitle">
                        <i class="fas fa-pen-nib"> </i> Cập Nhật Đơn Hàng
                    </p>
                    <div class="tabcat">
                        <div class="panel">
                            <ul>
                        ...
                        <table id="tab1">
                            ...
                            <tr>
                                <td>Cửa Hàng</td>
                                <td><input value="bee figure" type="text" placeholder="Tên Cửa Hàng" list="liststore"
                                        value="">
                            ...
                            <tr>
                                ...
                                <td><input value="increase wheel" type="text" placeholder="Họ Tên Khách Hàng"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Email</td>
                                <td><input value="eye rapidly" type="text" placeholder="Email Khách Hàng"></td>
                            </tr>
                            <tr>
                                <td>Số điện thoại</td>
                                <td><input value="refer letter" type="text" placeholder="Số điện thoại khách hàng"></td>
                            </tr>
                            <tr>
                                <td>Trạng Thái</td>
                                <td>
                        ...
                        <table id="tab2" border="1">
                            ...
                            <tr>
                                ...
                                <td td="tab2md"></td>
                                <td id="tab2up"></td>
                                <td id="tab2tt">300000</td>
                                <td><button id="addsale">+</button></td>
                            </tr>
                            <tr>
                                <td><input id="productname" value="tiny physical helpful" type="text" list="listproduct"
                                        placeholder="Tên Sản Phẩm"></td>
                                <td><input type="number" placeholder="Số lượng" value="1"></td>
                                <td><select name="aa" id="" placeholder="Màu Sắc">
                                        <option value="">Đỏ </option>
                                        <option value="like">Cam</option>
                                        <option value="president">Vàng </option>
                                        <option value="example">Xanh</option>
                                    </select></td>
                                <td><input type="number" placeholder="Đơn Giá" value="100000" disabled=""></td>
                                <td><input type="text" placeholder="Tổng Cộng" value="100000" disabled=""></td>
                                <td><button id="delsale">x</button></td>
                            </tr>
                            <tr>
                                <td><input id="productname" value="oxygen golden creature" type="text"
                                        list="listproduct" placeholder="Tên Sản Phẩm"></td>
                                <td><input type="number" placeholder="Số lượng" value="1"></td>
                                <td><select name="aa" id="" placeholder="Màu Sắc">
                                        <option value="">Đỏ </option>
                                        <option value="like">Cam</option>
                            ...
                            <tr>
                                <td><input id="productname" value="solution charge along" type="text" list="listproduct"
                                        placeholder="Tên Sản Phẩm"></td>
                                <td><input type="number" placeholder="Số lượng" value="1"></td>
                                <td><select name="aa" id="" placeholder="Màu Sắc">
                                        <option value="">Đỏ </option>
                        ...
                        <table id="tab3">
                            <div>
                                <tr>
                                    ...
                                    <td><input value="bicycle port" type="text" placeholder="Người Thanh Toán"></td>
                                </tr>
                                <tr>
                                    <td>Mã Số Thuế</td>
                                    <td><input value="land frighten" type="text" placeholder="Mã Số Thuế"></td>
                                </tr>
                                ...
                                <tr>
                                    <td>Mã Thẻ</td>
                                    <td><input value="push serve" type="text" placeholder="Mã Thẻ"></td>
                                </tr>
                                <tr>
                                    <td>Ngày Hết Hạn</td>
                                    <td><input value="good religious" type="text" placeholder="MM/YY"></td>
                                </tr>
                                <tr>
                                    <td>Mã Bảo Mật</td>
                                    <td><input value="helpful glad" type="text" placeholder="CVV/CCV"></td>
                                </tr>
                        </table>
                        ...
                        <table id="tab4">
                            ...
                            <tr>
                                <td>Số Nhà</td>
                                <td><input value="brave drawn" type="text" placeholder="Số Nhà"></td>
                            </tr>
                            <tr>
                                <td> Tên Đường</td>
                                <td><input value="why hurried" type="text" placeholder="Tên Đường"></td>
                            </tr>
                            <tr>
                                <td>Quận/Huyện</td>
                                <td><input value="labor catch" type="text" placeholder="Quận/Huyện"></td>
                            </tr>
                            <tr>
                                <td>Tỉnh/Thành Phố</td>
                                <td><input value="full mice" type="text" placeholder="Tỉnh/Thành Phố"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input value="lead coast" type="text" placeholder="Họ Tên Người Nhận"></td>
                            </tr>
                            <tr>
                                <td>Số Điện Thoại người nhận</td>
                                <td><input value="same mistake" type="text" placeholder="Số Điện Thoại người nhận"></td>
                            </tr>
                            <tr>
                                <td>Chú thích</td>
