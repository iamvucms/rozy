    ...
    <div class="right">
      ...
      <div class="bottom">
        ...
        <div class="catlist" id="add">
          <p class="cattitle">
            <i class="fas fa-pen-nib"> </i> Cập Nhật Sản Phẩm
          </p>
          <div class="tabcat">
            <div class="panel">
              <ul>
            ...
            <table id="tab1">
              ...
              <tr>
                <td>Tên sản phẩm</td>
                <td><input type="text" value="handsome" placeholder="Tên sản phẩm"></td>
              </tr>

              <tr>
                <td>Thẻ meta title</td>
                <td><input type="text" value="many" placeholder="Thẻ meta title"></td>
              </tr>
            ...
            <table id="tab2">
              ...
              <tr>
                ...
                <td><textarea type="text"
                    placeholder="Thẻ Meta mô tả	">send wolf mirror officer poor gate meat across interest chart ground scientific pupil movement definition larger sight eight wild rocky bear father part state</textarea>
                </td>
              </tr>
              <tr>
                <td>Thẻ Meta Keyword</td>
                <td><input type="text" value="congress" placeholder="Thẻ Meta Keyword"></td>
              </tr>
              <tr>
                <td>Mô tả sản phẩm</td>
                <td><textarea name="" id="destext" style="width:100%"
                    placeholder="Mô tả danh mục">happen atmosphere shall small shelter tape production tears express something pencil political private river apart breeze live clean special suddenly different none cry tongue</textarea>
                </td>
              </tr>
              <tr>
                <td>Gắn thẻ</td>
                <td><input type="text" value="while" placeholder="Ví dụ: Samsung_A30,Iphone_x"></td>
              </tr>
              <tr>
                <td>SEO Từ khóa</td>
                <td><input type="text" value="member" placeholder="SEO Từ Khóa	"></td>
              </tr>
              <tr>
                <td>SEO Mô tả</td>
                <td><textarea name="" id="" style="width:100%"
                    placeholder="SEO Mô tả">few milk pattern expression mixture watch experience wonder congress lie rise supply prize active happy suggest excitement log drove boy deeply beginning angle gift</textarea>
                </td>
              </tr>
              <tr>
                <td>SEO URL</td>
                <td><input type="text" value="muscle" placeholder="Ví dụ: dien-lanh-dien-tu"></td>
              </tr>
            </table>
            <table id="tab3">
              <div>
                <tr>
                  <td>Độ dày</td>
                  <td><input type="text" value="troops" placeholder="Độ dày"></td>
                </tr>
                <tr>
                  <td>Trọng lượng</td>
                  <td><input type="text" value="melted" placeholder="Trọng lượng"></td>
                </tr>

                <tr>
                  <td>Chất liệu</td>
                  <td><input type="text" value="believed" placeholder="Chất liệu"></td>
                </tr>
                <tr>
                  <td>Kích Thước</td>
                  <td><input type="text" value="disease" placeholder="Kích Thước"></td>
                </tr>
                <tr>
                  <td><input type="text" value="lamp" placeholder="Tên trường"
                      style="text-align: right;padding-right: 5px;font-weight: bold;"></td>
                  <td style="padding-left: 25px!important;"><input type="text" value="anywhere" placeholder="Giá trị">
                  </td>
            ...
            <table id="tab4">
              ...
              <tr>
                <td>Model</td>
                <td><input type="text" value="sing" placeholder="Model"></td>
              </tr>
              <tr>
                <td> Thương hiệu</td>
                <td><input type="text" value="old" placeholder="Thương hiệu"></td>
              </tr>
              <tr>
                <td>SKU</td>
                <td><input type="text" value="rush" placeholder="SKU"></td>
              </tr>
              <tr>
                <td>Số Lượng</td>
              ...
              <tr>
                <td>Sản xuất tại</td>
                <td><input type="text" value="land" placeholder="Sản xuất tại"></td>
              </tr>
