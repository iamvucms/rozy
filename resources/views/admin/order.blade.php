                    ...
                    <div class="cattitle">
                        ...
                        <ul class="catright">
                            ...
                            <li><i class="fas fa-radiation"></i> Thao Tác <i class="fas fa-angle-down"></i>
                                <ul>
                                    <li><a href="addorder.html" style="color:#555"><i class="fas fa-plus-circle"></i>
                                            Thêm mới</a></li>
                                    <li><i class="far fa-trash-alt"></i> Xóa</li>
                                    <li><a href="editorder.html" style="color:#555"><i class="far fa-edit"></i> Cập
                                            Nhật</a></li>
                                </ul>
                            </li>
                        </ul>
                                ...
                                <td>
                                    <div class="lasttd">
                                        ...
                                        <li id="showoption"><i class="fas fa-angle-down"></i>
                                            <ul>
                                                <li><i class="far fa-trash-alt"></i> Xóa</li>
                                                <li><a href="editorder.html" style="color:#555"><i
