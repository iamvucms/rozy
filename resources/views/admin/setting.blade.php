                                                  ...
                                                  <div class="tabcat">
                                                            ...
                                                            <table id="tab1" >
                                                                      ...
                                                                      <tr>
                                                                                ...
                                                                                <td><input value="Rozy Online Shop" type="text" placeholder="Thẻ Meta Title" list="liststore">
                                                                      ...
                                                                      <tr>
                                                                                ...
                                                                                <td><textarea type="text" placeholder="Thẻ Meta Description" style="line-height:normal" rows="5"></textarea></td>
                                                                      </tr>
                                                                      <tr>
                                                                                <td>Thẻ Meta Keyword</td>
                                                                                <td><textarea type="text" placeholder="Thẻ Meta Keyword" style="line-height:normal" rows="5"></textarea></td>
                                                                      </tr>
                                                                      <tr>
                                                                                <td>Giao diện</td>
                                                                                <td>
                                                                      ...
                                                                      <tr>
                                                                                <td></td>
                                                                                <td><button class="addcat" style="width:auto;padding:0px 7px;">Cập Nhật <i class="fas fa-arrow-right"></i></button></td>
                                                                      </tr>
                                                            </table>
                                                            <table id="tab2">
                                                                      ...
                                                                      <tr>
                                                                                <td >Tên cửa hàng</td>
                                                                                <td><input value="Rozy Online Shop" type="text" placeholder="Tên cửa hàng" list="liststore">
                                                                                </td>
                                                                      </tr>
                                                                      ...
                                                                      <tr>
                                                                                <td>Địa chỉ</td>
                                                                                <td><textarea type="text" placeholder="Địa chỉ" style="line-height:normal" rows="5"></textarea></td>
                                                                      </tr>
                                                                      <tr>
                                                                                <td >Email</td>
                                                                      ...
                                                                      <tr>
                                                                                <td>Số điện thoại</td>
                                                                                <td><input value="0123456789" type="text" placeholder="Số điện thoại" list="liststore"></td>
                                                                      </tr>
                                                                      <tr>
                                                                                <td>Fax</td>
                                                                      ...
                                                                      <tr>
                                                                                <td>Giờ làm việc</td>
                                                                                <td><textarea type="text" placeholder="Giờ làm việc" style="line-height:normal" rows="5"></textarea></td>
                                                                      </tr>
                                                                      <tr>
                                                                                <td>Mô tả cửa hàng</td>
                                                                                <td><textarea type="text" placeholder="Mô tả cửa hàng" style="line-height:normal" rows="5"></textarea></td>
                                                                      </tr>     
                                                            ...
                                                            <table id="tab4">
                                                                      ...
                                                                      <tr>
                                                                                ...
                                                                                <td><textarea type="text" placeholder="Chú thích " style="line-height:normal" rows="5"></textarea></td>
                                                                      </tr>
                                                                      <tr>
                                                                                <td></td>
                                                                                <td><button class="addcat" style="width:auto;padding:0px 7px;">Cập Nhật <i class="fas fa-arrow-right"></i></button></td>
