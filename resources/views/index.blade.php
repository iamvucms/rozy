                     ...
                     <div class="scrolllog">
                        <ul>
                           <li class="left">
                              ...
                              <p class="msgcontent">buy slowly metal tiny land declared finish stage wide correct truck
                                 warm zoo exchange structure figure brain women so my behavior primitive east
                                 understanding</p>
                           </li>
                           <li class="left">
                              <img src="admin/assets/img/avt.jpg" alt="" class="avtsend">
                           ...
                           <li class="right">
                              <p class="msgcontent">askraw student driven worse religious worried trail globe nest
                                 article wood birth love tower recent stream island outside chance stay band late piece
                                 bone before </p>
                           </li>
                           <li class="right">
                              <p class="msgcontent">labelmad driven wing avoid ear price support slightly doll check
                                 perhaps force policeman action industry physical command coal forest second cream
                                 spider silent job stiff </p>
                           </li>
                           <li class="left">
                              <img src="admin/assets/img/avt.jpg" alt="" class="avtsend">
                              <p class="msgcontent">buy slowly metal tiny land declared finish stage wide correct truck
                           ...
                           <div class="sendform" id="login">
                              ...
                              <form action="">
                                 ...
                                 <div class="inputgroup">
                                    ...
                                    <input type="text" name="email" placeholder="Mật khẩu đăng nhập" autocomplete="off">
                                 </div>
                           ...
                           <div class="sendform" id="forgot" style="position: relative;">
                              ...
                              <form action="">
                                 ...
                                 <div class="inputgroup">
                                    ...
                                    <input type="text" name="phoneormail" placeholder="Email hoặc số điện thoại"
                                       autocomplete="off">
                                 </div>
               ...
               <div class="salesproducts">
                  ...
                  <div class="product">
                     ...
                     <div class="product_price">
                        @if (count($discount)>0)
                        <span
                           class="newprice">{{number_format($flash->Product()->price-$discount[0]->percent/100*$flash->Product()->price)}}
                           <sup>đ</sup></span>
                        <span class="oldprice">{{number_format($flash->Product()->price)}} <sup>đ</sup></span>
                        @else
                        <span class="newprice">{{number_format($flash->Product()->price)}} <sup>đ</sup></span>
                        @endif
                     </div>
                     <div class="remaining">
                        <p class="rbar">&emsp;
