                                ...
                                <div class="shopAvt">
                                    ...
                                    <p class="sName">{{$seller->name}}</p>
                                        ...
                                        <div class="btnIntro">
                                            ...
                                            <button onclick="addLoveShop()"><i class="far fa-heart"></i> Yêu Thích</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="flashsales" id="foryou">
                        ...
                        <div class="salesproducts">
                            <div class="product" data-popular="45" data-date="64" data-vote="38" data-sales="75">
                                <div class="imgbox">
                                    <a href="#viewflash"><img src="../assets/img/jeanproduct.jpg" alt=""></a>
                                    <div class="groupcart">
                                        <a href="#cartoption">
                                            <button title="Thêm vào danh sách yêu thích"><i
                                                    class="fas fa-heart"></i></button></a>
                                        <a href="#cartoption">
                                            <button title="So sánh"><i class="fas fa-exchange-alt"></i></button></a>
                                        <a href="#cartoption">
                                            <button title="Thêm vào giỏ hàng"><i
                                                    class="fas fa-cart-plus"></i></button></a>
                                    </div>
                                </div>

                                <div class="salespercent">-30%</div>
                                <div class="product_name"><a href="detail.html">Samsung
                                        Galaxy S8 64Gb, 4Gb
                                        Ram</a></div>
                            ...
                            <div class="product" data-popular="11" data-date="68" data-vote="38" data-sales="22">
                                <div class="imgbox">
                                    <a href="#viewflash"><img src="../assets/img/aokhoac.jpg" alt=""></a>
                                    <div class="groupcart">
                                        <a href="#cartoption">
                                            <button title="Thêm vào danh sách yêu thích"><i
                                                    class="fas fa-heart"></i></button></a>
                            ...
                            <div class="product" data-popular="72" data-date="8" data-vote="45" data-sales="25">
                                <div class="imgbox">
                                    <a href="#viewflash"><img src="../assets/img/aothun.jpg" alt=""></a>
                                    <div class="groupcart">
                                        <a href="#cartoption">
                                            <button title="Thêm vào danh sách yêu thích"><i
                                                    class="fas fa-heart"></i></button></a>
                            ...
                            <div class="product" data-popular="61" data-date="69" data-vote="92" data-sales="99">
                                <div class="imgbox">
                                    <a href="#viewflash"><img src="../assets/img/aongu.jpg" alt=""></a>
                                    <div class="groupcart">
                                        <a href="#cartoption">
                                            <button title="Thêm vào danh sách yêu thích"><i
                                                    class="fas fa-heart"></i></button></a>
                            ...
                            <div class="product" data-popular="84" data-date="37" data-vote="32" data-sales="78">
                                <div class="imgbox">
                                    <a href="#viewflash"><img src="../assets/img/somi.jpg" alt=""></a>
                                    <div class="groupcart">
                                        <a href="#cartoption">
                                            <button title="Thêm vào danh sách yêu thích"><i
                                                    class="fas fa-heart"></i></button></a>
                            ...
                            <div class="product" data-popular="17" data-date="92" data-vote="18" data-sales="28">
                                <div class="imgbox">
                                    <a href="#viewflash"><img src="../assets/img/kaki.jpg" alt=""></a>
                                    <div class="groupcart">
                                        <a href="#cartoption">
                                            <button title="Thêm vào danh sách yêu thích"><i
                                                    class="fas fa-heart"></i></button></a>
